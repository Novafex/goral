...
func (c *AdvisorService) PaginateAdvisor(filter api_structure.Advisor) ([]api_structure.Advisor, error) {return []api_structure.Advisor{},nil 
}

func (c *AdvisorService) InfiniteAdvisor(filter api_structure.Advisor) ([]api_structure.Advisor, error) {return []api_structure.Advisor{},nil 
}
