...
//go:generate mockgen -destination=../mocks/services/customer.go -package=goral generate/goral/services ICustomer
...
func (c *CustomerService) PaginateCustomer(filter api_structure.Customer) ([]api_structure.Customer, error) {
	return []api_structure.Customer{}, nil
}

func (c *CustomerService) InfiniteCustomer(filter api_structure.Customer) ([]api_structure.Customer, error) {
	return []api_structure.Customer{}, nil
}
